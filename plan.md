...
- durable ingestion checkpoint as of 2026-05-05:
  ...
  - before relying on full DAI R2 archival in production, add per-source timeout/skip handling for expensive sources; a manual proof attempt against large `DAI-2022-0386` ran too long and was manually cancelled, leaving the source still due
