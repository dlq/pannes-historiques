...
- Deployment prerequisites complete: production D1 migration `0012_usage_evidence.sql` is applied and the shared `autocomplete and usage per IP` edge rule is active. Deployment and production smoke checks remain.
