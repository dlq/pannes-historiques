...
remediation timeline when practical.

## Scope

The public site, Cloudflare Worker routes, container boundary, and repository code are in scope.
Third-party services and publicly available Hydro-Quebec source data are not controlled by this
project, though reports about unsafe handling of those inputs are welcome.
