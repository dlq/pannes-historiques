...
- Latest production deployment: post-release commit `d8ed6af`, deployed 2026-09-11 as Worker version `b218a776-8312-4b05-9eed-c68350538b5e`; the existing container image was unchanged. D1 migrations `0011` through `0013`, 15-minute Hydro ingestion, archive cursor warning classification, the split archive cursor read path, and the `v0.4.9` usage-evidence path are production-verified.
