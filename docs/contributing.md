...
- Worker routing or endpoint privacy: start in `src/worker-routing.js` and `src/runtime-policy.js`; bounded usage collection and its private readout live in `src/usage-evidence.js`.
