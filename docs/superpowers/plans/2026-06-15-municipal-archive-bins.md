...
- [ ] **Step 1: Write tests for point containment, bbox overlap, simplification, and hybrid assignment**
...
- [ ] **Step 1: Add territory and bin tables**
...
- [ ] **Step 1: Import helper functions into Worker**

Add imports from `./municipal-archive.js`.

- [ ] **Step 2: Add operational-only runtime endpoints**
...
- [ ] **Step 3: Implement territory import**
...
- [ ] **Step 4: Implement resumable bin backfill**
...
- [ ] **Step 1: Prefer municipal bins in no-address archive summary**
...
- [ ] **Step 3: Keep map-layer fallback**
...
- [ ] **Step 2: Run JS formatting/checks**
...
- [ ] **Step 4: Report production follow-up**
