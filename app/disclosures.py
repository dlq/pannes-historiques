...
DISCLOSURE_SOURCES = (
    ...
    DisclosureSource(
        ...
        notes="PDF table with start, end, duration, and cause. Parsed into row-level disclosure events.",
    ...
    DisclosureSource(
        ...
        extraction_method="pdf_rows",
        precision_label="municipality_context",
        notes="PDF table with row-level events for multiple municipalities. Parsed into row-level disclosure events.",
        centroid_lat=45.95,
        centroid_lon=-76.7,
    ),
    DisclosureSource(
        ...
        extraction_method="pdf_rows",
        precision_label="municipality_context",
        notes="PDF table with start, end, duration, cause, and municipality. Parsed into row-level disclosure events.",
